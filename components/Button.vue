<template>
  <div
    ...
    :style="{ transform: isOpen ? 'translateX(0)' : 'translateX(-94px)' }"
  >
    <nuxt-link to="/myJourney">
      <button
        class="button-85 transition-transform ease-in-out duration-1000 delay-1000"
        role="button"
        @mouseover="handleClick"
        @mouseleave="handleClick2"
      >
        <div class="flex content-center items-center gap-2 divide-x">
          <div class="text-xs ms-2">My Journey</div>
          <div class="ps-1">
            <svg
