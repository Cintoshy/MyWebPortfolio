      ...
      >
        ...
        <img
          ...
          style="
            ...
            box-shadow: 8px 8px 16px #751b1b, -8px -8px 16px #a52525;
          "
        />
      </div>
    </div>
    <Button class="fixed top-8 md:top-20 left-0" />
  </section>
</template>
...
.text {
  ...
  margin-right: 10px;
  overflow: hidden;
  animation: typing 3s, cursor 0.9s step-end infinite alternate;
}
@keyframes cursor {
  50% {
