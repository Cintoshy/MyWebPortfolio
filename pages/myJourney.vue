<template>
  <div class="w-full">
    <div class="mx-5 lg:mx-60 mb-10">
      <div
        class="flex items-center h-36 bg-slate-400 mt-5 gap-5 sm:gap-10 bg-opacity-50 rounded-t-md"
      >
        <div>
          <img
      ...
      <div class="h-full bg-slate-500 p-5 sm:p-10 bg-opacity-20">
      ...
      <div
        class="flex flex-col bg-slate-600 h-full p-5 md:p-10 bg-opacity-50 rounded-b-md"
      >
        <div class="w-full">
